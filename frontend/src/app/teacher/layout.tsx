...
export default function TeacherLayout({
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#f0f4f8] print:block print:h-auto print:bg-white text-gray-900">
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden print:block print:overflow-visible">
        ...
        <main className="flex-1 overflow-y-auto hide-scrollbar print:p-0 print:m-0 print:overflow-visible bg-[#f8fafc]">
          <ProtectedRoute>
